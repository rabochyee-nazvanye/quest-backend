...
{
    [DbContext(typeof(Db))]
    [Migration("20211210101601_AddQuestIsRegistrationLimited")]
    partial class AddQuestIsRegistrationLimited
    {
            ...
            modelBuilder.Entity("Quest.Domain.Models.QuestEntity", b =>
                {
                    ...
                    b.Property<bool>("IsRegistrationLimited")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Quest.Domain.Models.Team", b =>
                {
                    ...
                    b.Property<DateTime>("TasksOpenTime")
                        .HasColumnType("timestamp without time zone");
